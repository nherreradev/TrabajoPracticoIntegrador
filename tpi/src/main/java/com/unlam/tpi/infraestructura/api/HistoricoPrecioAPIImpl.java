...
@Service
public class HistoricoPrecioAPIImpl implements HistoricoPrecioAPI {
	...
	public HistoricoPrecioAPIImpl(RestTemplate restTemplate) {
	...
	public List<HistoricoInstrumento> getHistoricoMongo(String rango, String instrumento, String simbolo) {
		switch (rango) {
		case "mensual":
			return this.historicoRepositorio.getInstrumentoPorRangoFechaSinId("mensual", instrumento, simbolo);
		case "trimestral":
			return this.historicoRepositorio.getInstrumentoPorRangoFechaSinId("trimestral", instrumento, simbolo);
		case "semestral":
			return this.historicoRepositorio.getInstrumentoPorRangoFechaSinId("semestral", instrumento, simbolo);
		default:
	...
	private void convertirJsonAHistoricoDTO(String simbolo, HashSet<HistoricoInstrumentoDTO> listaHistoricoDTO,
			JsonArray jsonArray) {
	...
	private void completarDTO(HistoricoInstrumentoDTO historicoInstrumentoDTO, JsonPrimitive apertura,
		...
		if (fechaHora != null && fechaHora.isString()) {
			...
			historicoInstrumentoDTO
					.setFecha(fechaHora.getAsString().substring(0, fechaHora.getAsString().indexOf('T')));
		}
	}
